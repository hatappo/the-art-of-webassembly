(module
  ...
  ;; リスト 5-21 の$set_bin_string 関数のコード
  ...
  ;; リスト 5-19 の$set_hex_string 関数のコード
  ...
  ;; リスト 5-16 の$set_dec_string 関数のコード  
  ...
  ;; リスト 5-12 の$byte copy i64 関数のコード
  (func $byte_copy_i64
    (param $source i32) (param $dest i32) (param $len i32)
    (local $last_source_byte i32)
    local.get $source
  ...
  (func (export "setOutput") (param $num i32) (result i32)
    ...
    i32.const 0
    global.set $out_str_len ;; $out_str_len を 0 に設定
